...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Buy Package</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">Vendor is requested to buy the new package, Details are mentioned below.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
                  ...
                  <td width="560" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-color:#EFEFEF;border-style:solid;border-width:0px;border-radius:3px;background-color:#FFFFFF;padding-bottom: 30px;padding-left: 30px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff"> 
                     ...
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 150px;">Email</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($value->email))?': &nbsp;'.$value->email:''; ?></td> 
                     </tr>
                     ...
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 150px;">Phone</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($value->phone))?': &nbsp;'.$value->phone:''; ?></td> 
                     </tr>

                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 150px;">Package</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($package))?': &nbsp;'.$package:''; ?></td> 
                     </tr>
