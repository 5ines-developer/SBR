...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="assets/css/bootstrap3.min.css">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noPadd slides-container p0" style="height:100%">
				...
				<div class="slide">
					<div class=" hedaer-inner">
						<img src="assets/img6/header-image/image01.jpg" alt="image01">
	...
	<section class="yellow_section section_gap pb-sm-0" id="theCouple">
		<div class="container">
			...
			<div class="row clearfix theCouple">
				<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5"> <img src="assets/img6/bride.jpg" alt=" "
						class="bigRound" />
					<h3>Sophie takas</h3>
					<h5>Budapest, Hungary</h5>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et pulvinar augue. Nullam dignissim
						condimentum purus, vitae feugiat augue ornare ut. Praesent imperdiet purus ante, sagittis
						efficitur leo vehicula nec.</p>
					
				</div>
				<div class="col-md-2 col-lg-2 line"> <i class="fa fa-heart"></i> </div>
				<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5"> <img src="assets/img6/groom.jpg" alt=" "
						class="bigRound" />
					<h3>Andy Collins</h3>
					<h5>San Francisco</h5>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et pulvinar augue. Nullam dignissim
	...
	<section class="section_gap" id="eventsSchedule">
		<div class="container">
			...
			<div class="row events clearfix">
				<div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 events"> <img src="assets/img6/engagement.jpg" alt=" " />
					<div class="desc">
						<h4><a href="#">Engagement</a><span>September 14, 2015 3:00 pm</span></h4>
						<p>Tnsectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut labore et dolore magna
							a aliqua</p>
					</div>
				</div>
				<div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 events"> <img src="assets/img6/wedding-ceremony.jpg"
						alt=" " />
					<div class="desc">
				...
				<div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4"> <img src="assets/img6/wedding-reception.jpg" alt=" " />
					<div class="desc">
		...
		<div class="container">
			...
			<div class="row bride">
				<ul class="clearfix">
					...
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img src="assets/img6/bride-maid.jpg" alt=" "
							class="smallRound" />
						<h4>Krisy Gabor<span>Bridemaid</span></h4>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img alt="" src="assets/img6/bride-father.jpg"
							class="smallRound" />
						<h4>John Takas<span>Bride's Father</span></h4>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img alt="" src="assets/img6/bride-mother.jpg"
							class="smallRound" />
			...
			<div class="row groom">
				<ul class="clearfix">
					...
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img src="assets/img6/best-man.jpg" alt=" "
							class="smallRound" />
						<h4>David William<span>Best man</span></h4>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img alt="" src="assets/img6/groom-father.jpg"
							class="smallRound" />
						<h4>Ben Collins<span>Groom's Father</span></h4>
					</li>
					<li class="col-xs-12 col-sm-3 col-md-3 col-lg-3 circle"> <img alt="" src="assets/img6/groom-mother.jpg"
							class="smallRound" />
			...
			<div class="row gallery">
				<ul class="thumbnails">
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/1.jpg"
									title="Album Title1" class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb1.jpg" title="Image Title" /> </li>
					<!--end thumb -->
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/2.jpg"
									  class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb2.jpg" title="Image Title" /> </li>
					<!--end thumb -->
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/3.jpg"
									  class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb3.jpg" title="Image Title" /> </li>
					<!--end thumb -->
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/4.jpg"
									  class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb4.jpg" title="Image Title" /> </li>
					<!--end thumb -->
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/5.jpg"
									  class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb5.jpg" title="Image Title" /> </li>
					<!--end thumb -->
					<li class="span3 col-xs-12 col-sm-4 col-md-4 col-lg-4"> <span class="hoverZoom"> <span
								class="smallIcon"> <a rel="lightbox-demo" href="assets/img6/gallery/big-images/6.jpg"
									  class="zoom lb lb_warsaw1"><i
										class="fa fa-search fa-2x"></i></a> </span> </span> <img class="group1"
							src="assets/img6/gallery/thumb-images/thumb6.jpg" title="Image Title" /> </li>
					<!--end thumb -->
				</ul>
			</div>
			<!-- /.row -->
		...
		<div class="container">
			<div class="row heading rsvp">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
					<h4  class="text-white"><span></span> GROOM : (<a href="tel:+">+91 1234567890</a>)</h4>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
				<h4  class="text-white"> <span></span> BRIDE : (<a href="tel:+">+91 1234567890</a>)</h4>
				</div>
			</div>
		</div>
	</section>
