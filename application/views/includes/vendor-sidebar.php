<div class="col l3 m4 s12">
    <div class="left-vendor-menu b-sho white">
        <ul class="vendor-dash-list">
            ...
            <li>
                <a  href="<?php echo base_url('vendor/leads') ?>" class="<?php echo ($this->uri->segment(2) =='leads' && $this->uri->segment(1) =='vendor')?'active':'' ?>"><i class=" material-icons vender-icon">insert_drive_file</i> Leads <span class="count-badge"><?php echo leads(); ?></span></a>
            </li>
            <li>
