                                    ...
                                    <div class="form-container">
                                        ...
                                        <form action="<?php echo base_url('vendors/upgrade-update') ?>" method="post"  id="admin-form" enctype="multipart/form-data">
                                          ...
                                          <div class="row m0">
                                                ...
                                                <div class="input-field col s12 l6" id="ban_pck<?php if ($result->ban_pack) {echo '1'; } ?>"> 
                                                ...
                                                <div class="input-field col s12 l6">
                                                  <select id="tenure" name="tenure" required="">
                                                      ...
                                                      foreach ($months as $key => $value) { ?>
                                                       <option value="<?php echo $key+1; ?>" <?php if($result->tenure ==  $key+1){ echo 'selected'; } ?>><?php echo $value.' + 1 Months';?></option>
                                                      <?php }?>
                                                  </select>
                                          ...
                                          <div class="row m0">
                                                ...
                                                <div class="input-field col s12 l6">
                                                  <input type="text" autofocus="" required id="discount" name="discount" class="validate" value="<?php echo (!empty($result->discount))?$result->discount:''; ?>">
                                          ...
                                          <div class="row m0">
                                            ...
                                            <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                    <input type="text" id="pdc_mode" name="pdc_mode" class="validate" value="<?php echo (!empty($result->pdc_mode))?$result->pdc_mode:''; ?>">
                                                  <label for="pdc_mode">Payment Mode </label>
                                                </div>
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="pdc_instrmnt" name="pdc_instrmnt" class="validate" value="<?php echo (!empty($result->pdc_instrmnt))?$result->pdc_instrmnt:''; ?>">
                                                  <label for="pdc_instrmnt">Instrument No </label>
                                                </div>
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="pdc_pay_date" name="pdc_pay_date" class="datepicker validate" value="<?php echo (!empty($result->pdc_pay_date))?$result->pdc_pay_date:''; ?>">
                                                  <label for="pdc_pay_date">Payment Date </label>
                                                </div>
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="pdc_amount" name="pdc_amount" class="validate" value="<?php echo (!empty($result->pdc_amount))?$result->pdc_amount:''; ?>">
