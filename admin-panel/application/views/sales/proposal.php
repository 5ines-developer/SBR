...
<html>
  <head>
    ...
    .bordered tr td {font-size: 13px; font-weight: 600;}
    td, th {
    padding: 8px 5px; }
    .top-head span{
      font-size: 12px;
                  ...
                  <div class="form-container">
                    ...
                    <table class="bordered">
                      ...
                      <tr class="bg1">
                        ...
                        <td >Tenure : <?php echo (!empty($result['tenure']))?$result['tenure']:''; ?></td>
                      </tr>
                      <tr>
                        <td colspan="3"></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>Total Discount : <?php echo (!empty($result['discount']))?$result['discount']:''; ?></td>
                      </tr>
                      <tr class="bg1">
                      ...
                      <tr>
                        <td colspan="3"> Amount In Words : <?php echo (!empty($result['am_words']))?$result['am_words']:''; ?></td>
                      </tr>
                      <tr>
                        <td colspan="3"></td>
                      </tr>
                          ...
                          <tr>
                            <td>
                              <ol>
                                ...
                                <li style="border-bottom: 1px solid #d0021b;padding-bottom: 15px;"><b>Jurisdiction and Dispute Resolution -</b> Any disputes arising out of or in connection with this agreement, during its subsistence and after its termination in any manner whatsoever, including the validity of this Agreement shall be referred to arbitration of a sole arbitrator nominated by the Baraati Media & Entertainment Pvt Ltd. to the dispute in accordance with the provisions contained in the Arbitration and Conciliation Act, 1996 or any amendment made thereto. The place of Arbitration shall be Bengaluru and the language of Arbitration shall be English. The decision of the arbitrator shall be final and binding on the parties. </li>
