                ...
                <div class="card-content">
                  <div class="form-container">
                    ...
                    <table class="bordered">
                      <tbody>
                        <tr>
                        <th style="border-top: 1px solid gray;border-bottom: 1px solid gray;border-left: 1px solid gray;border-right:none;" colspan="2" class="right-align">Order & Agreement Form</th>
                      ...
                      <tr>
                        <td style="border: 1px solid gray;" colspan="3"> Billing Name: <?php echo (!empty($result['in_name']))?$result['in_name']:''; ?></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid gray;" colspan="3">GST NO : <?php echo (!empty($result['gstno']))?$result['gstno']:''; ?></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid gray; position: relative; top: -15px; bottom: 0; height: 68px;" colspan="3" height="100px;">Address :  <?php echo (!empty($result['laddress']))?$result['laddress']:''; ?></td>
                      </tr> 
                      <tr>
                        <td style="border: 1px solid gray;" colspan="3">City : <?php echo (!empty($result['city']))?$result['city']:''; ?></td>
                      </tr>
                      ...
                      <tr style="border-bottom:none;">
                        ...
                        <td colspan="1" style="border-top:none;border-bottom:none;border-right: 1px solid gray;border-left: 1px solid gray;">Package Name: <?php echo (!empty($result['title']))?$result['title']:''; ?></td>
                        ...
                        <tr style="border-bottom:none;">
                          <td style="border-top:none;border-bottom:none;border-right: 1px solid gray;border-left: 1px solid gray;"></td>
                          <td colspan="1" style="float:right;border:none;">Discount -</td>
                          ...
                          <tr>
                            <td style="border: 1px solid gray;" colspan="3">
                              <small>As Per section 194 C Income Tax TDS applicable for Online Advertisement is 2%</small>
                            </td>
                          </tr>
