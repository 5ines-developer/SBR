                        ...
                        <div class="row ">
                           <div class="col l2 m6 s12 p0">
                              <a href="<?php echo base_url('vendors/new-proposal') ?>">
                                 <div class="list-dashboard green active z-depth-0">
                                    <p class="para-p1 m0 center-align white-text">New Proposal</p>
                                 </div>
                              </a>
                           </div>
                           <div class="col l2 m6 s12 p0">
                             <a href="<?php echo base_url('vendors/approved-proposal') ?>">
                                 <div class="list-dashboard white z-depth-0">
                                    <p class="para-p1 grey-text m0 center-align">Approved</p>
                                 </div>
                              </a>
                           </div>
                           <div class="col l2 m6 s12 p0">
                           <a href="<?php echo base_url('vendors/rejected-proposal') ?>">
                                 <div class="list-dashboard white z-depth-0">
                                    <p class="para-p1 grey-text m0 center-align">Rejected</p>
                                 </div>
                              </a>
                           </div>
                           <div class="col l2 m6 s12 p0">
                     ...
                     <div class="shorting-table">
                        <div class="row">
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">New Proposal</p>
