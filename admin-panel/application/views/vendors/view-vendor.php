        ...
        <div class="col l12 m12 s12">
          <div class="row">
            ...
            <div class="col m12 s12 l9">
              ...
              <div class="row">
                <p class="h5-para black-text  m0">Vendor Details - <?php echo (!empty($result->name))?$result->name:'---'  ?></p>
                      ...
                      <div class="card-content">
                        <div class="row m0">
                          <div class="col s12 m5 border-right">
                            ...
                            <img src="<?php echo !empty($result->profile_file)?$this->config->item('web_url').$result->profile_file :'https://via.placeholder.com/150'  ?>" alt="" class="circle responsive-img left mr10" width="120px"  height="100px;" />
                            
                            <div class="ptb10">
                              <h6 class="bold"><?php echo (!empty($result->name))?$result->name:'---'  ?></h6>
                              <h6><small><a href="mailto:<?php echo (!empty($result->email))?$result->email:'---'  ?>" ><?php echo (!empty($result->email))?$result->email:'---'  ?></a></small></h6>
                              <h6><small><a href="tel:<?php echo (!empty($result->phone))?$result->phone:'---'  ?>"><?php echo (!empty($result->phone))?$result->phone:'---'  ?></a></small></h6>
                            </div>
                          </div>
                          <div class="col s12 m7">
                            <div class="row m0">
                              <div class="col s12 center m6">
                                <h5 class="green-text darken-3"><?php echo count($enquiry) ?></h5>
                                <p>Total Enquiries</p>
                              </div>
                              ...
                              <div class="col s12 center m4 mt40">
                                ...
                                <a href="<?php echo base_url('users/block/'.$result->id.'') ?>" class="waves-effect waves-light btn red hoverable white-text darken-4 plr40" id="block">Block</a>
                                <?php }elseif ((!empty($result->is_active)) && $result->is_active == '2') { ?>
                                <a href="<?php echo base_url('users/unblock/'.$result->id.'') ?>" class="waves-effect waves-light btn green hoverable white-text darken-4 plr40" id="unblock">Unblock</a>
                                <?php } ?>
                                <a href="<?php echo base_url('users/block/'.$result->id.'') ?>" class="waves-effect waves-light btn red hoverable white-text darken-4 plr40" id="block" style="display: none">Block</a>
                                <a href="<?php echo base_url('users/unblock/'.$result->id.'') ?>" class="waves-effect waves-light btn green hoverable white-text darken-4 plr40" id="unblock" style="display: none">Unblock</a>
                      ...
                      <table>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo (!empty($result->registered_date))?date("M d, Y ", strtotime($result->registered_date)):'---'; ?></td>
                          </tr>
                          <tr>
                    ...
                    <div class="card-content">
                      ...
                      <ul class="profile-box">
                        ...
                        <li class="profile-items">
                          ...
                          <div class="profile-item-content">
                            <p><?php echo (!empty($result->specification))?$result->specification:'---'  ?></p>
                          </div>
                        </li>
                        <li class="profile-items">
                          <div class="profile-item-title">
                        ...
                        <div class="row">
                          <?php if (!empty($port)) {
                              ...
                              <div class="col s12 l3 m6 ">
                                  <img class="materialboxed z-depth-1" width="200" src="<?php echo $this->config->item('web_url').'/vendor-portfolio/'.$value->thumb_image ?>">
                                </div>
                           <?php } } ?>
                        </div>
                    </div>
