                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Free Quote Request</p>
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <tr>
                                            ...
                                            <td ><a href="<?php echo base_url('enquiries/view/'.$value->id.'') ?>"><?php echo (!empty($value->firstname))?$value->firstname.$value->lastname:'---'  ?></a></td>
                                            ...
                                            <td ><a href="<?php echo base_url('enquiries/view/'.$value->id.'') ?>"><?php echo (!empty($value->service))?$value->service:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiries/view/'.$value->id.'') ?>"><?php echo (!empty($value->city))?$value->city:'---'  ?></a></td>
                                            <td ><a href="<?php echo base_url('enquiries/view/'.$value->id.'') ?>"><?php echo (!empty($value->budget))?$value->budget:'---'  ?></a></td>
