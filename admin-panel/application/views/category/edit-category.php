                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>category/update" method="post" style="overflow-y: auto;overflow-x: hidden;" id="city-form" enctype="multipart/form-data">
                                        
                                          
                                          <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="category" name="category" class="validate" required value="<?php echo (!empty($result->category)?$result->category:'') ?>">
                                            ...
                                            <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="subtitle" name="subtitle" class="validate" value="<?php echo (!empty($result->subtitle)?$result->subtitle:'') ?>">
