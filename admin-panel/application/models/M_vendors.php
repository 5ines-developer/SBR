...
class M_vendors extends CI_Model {
    ...
    **/
	public function get_vendors($id='',$filt='')
	{
		...
		$this->db->select('ven.id as id, ven.name as name , ven.phone as phone , ven.email as email, cty.city as city, cat.category as category,ven.registered_date as regdate,ven.is_active as status,pac.title,ven.package,ven.upgrad,ven.verified,ven.v_chat');
